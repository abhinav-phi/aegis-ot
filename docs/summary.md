...
**Step 9 (2026-08-28) update:** suite now **106 passed · 2 skipped · 0 failed** (+28 tests: KB corpus guards, hallucination probe, experiment-config presence). Completed: RAG-01 ≥10 playbooks (11 authored), P4.3 hallucination probe harness, EXP-03 committed config, and a RAG-04 data-loss fix (`LocalVectorStore.upsert` clobbered the collection per document — now merges + re-indexes; corpus hit-rate@5 0.3 → 0.5). Docs synced: Schema.md corruption repaired, quick_summary refreshed, TechSpec/Design deviation notes recorded. Full record: `Tracker.md` → "Step 9".
